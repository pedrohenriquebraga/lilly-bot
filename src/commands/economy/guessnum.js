...
module.exports = {
  ...
  async execute(msg, args) {
    ...
    if (differenceNumber == 1 || differenceNumber == -1) {
      const earnMoney = currentMoney - Math.trunc(stakeValue / 2);
      ...
      return msg.reply(
        `Você quase acertou, eu pensei no número **${generatedNumber}** e você no **${suggestedNumber}**!! **Por quase ter acertado, tome ${stakeValue / 2} DinDins de volta!!**`
      );
    }
