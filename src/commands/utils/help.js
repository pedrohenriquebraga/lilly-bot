    ...
    execute(msg, args) {
        const serverInfoEmbed = new Discord.MessageEmbed()
            ...
            .addFields(
                ...
                { name: '🌐 Acesse meu Website', value: '[Acesse meu site para ter mais informações sobre mim](https://lilly-website.herokuapp.com/)' },
                { name: '<> Meus comandos', value: `[Veja a minha lista completa de comandos](https://lilly-website.herokuapp.com/commands)` }
            )
